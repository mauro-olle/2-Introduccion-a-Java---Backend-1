 ...
 */
package ejercicio3.guia7;

import ejercicio3.guia7.Entitdades.Operacion;
...
public class Ejercicio3Guia7 {
    ...
    public static void main(String[] args) {
        ...
        Operacion primeraOp = new Operacion();
        
        primeraOp.CrearOperacion(5, 0);
        
        System.out.println("La suma es " + primeraOp.Sumar());
        System.out.println("La resta es " + primeraOp.Restar());
        System.out.println("La multiplicacion es " + primeraOp.Multiplicar());
        System.out.println("La division es " + primeraOp.Dividir());
    }
