...
public class Ejercicio1Guia9 {
    ...
    public static void main(String[] args) {
        ...
        Cadena palabra = new Cadena("Vamos de caceria");
        
       /* cs.ContarVocales(palabra);
        cs.InvertirFrase(palabra);
        cs.VecesRepetido(palabra);
        cs.CompararLongitud(palabra);
        cs.UnirFrases(palabra); */
        cs.Reemplazar(palabra);
        System.out.println(cs.Contiene(palabra));
    }
}
